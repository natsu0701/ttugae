...
export const FEATURE_TABS: FeatureTab[] = [
  {
    ...
    imagePath: assetUrl("/images/Editor Page.png"),
    icon: PatternsFillIcon,
  },
  {
    id: "chatbot",
    title: "AI 챗봇",
    ...
    imagePath: assetUrl("/images/Tteuni AI Chat.png"),
    icon: ChatFillIcon,
  },
  {
    id: "converter",
    ...
    imagePath: assetUrl("/images/Converting Designs into Descriptive Text.png"),
