...
export default function EditorRightSidebar({
  ...
  return (
    <div className="relative flex h-full max-h-[calc(100vh-6rem)] shrink-0 flex-col">
      ...
      >
        {isCollapsed ? (
          <ChevronRight className="h-4 w-4 text-stone-600" strokeWidth={2} />
        ) : (
          <ChevronLeft className="h-4 w-4 text-stone-600" strokeWidth={2} />
        )}
      </button>
      ...
      <div
        ...
        className="absolute left-0 top-0 z-20 h-full w-1 cursor-col-resize transition-colors hover:bg-pink-300"
      />
