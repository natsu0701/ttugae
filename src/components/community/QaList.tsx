        ...
        {pageItems.map((post) => (
          <li key={post.id}>
            ...
            >
              ...
              <p className="mt-2 line-clamp-2 font-sans text-base font-normal leading-relaxed text-gray-600">
                {post.excerpt}
              </p>
              <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-1 font-sans text-sm font-normal text-gray-500">
