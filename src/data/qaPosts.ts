...
몸통 도안은 그대로 두고 소매 단만 늘리려면 몇 단을 더 떠야 할까요? 게이지(Gauge)는 10cm에 22코 28단 정도 나옵니다.`,
  },
  {
    ...
    body: `뜨개라운지 도안 미리보기에서는 부드러운 코랄인데, 실제 뜨니 #FC5F53에 가깝지만 너무 쨍해 보입니다.
...
비슷한 톤의 대체 실 브랜드나, 색을 톤 다운하는 방법이 있을까요?`,
  },
  {
    ...
    excerpt: "뜨개라운지 카드에서 에디터로 불러오기를 눌렀는데 빈 격자만 나와요.",
    author: "에디터테스트",
...
export const QA_ANSWERS: QaAnswer[] = [
  ...
  },
  {
    ...
    body: "곰돌이 도안은 불러오기가 됩니다. 빈 격자로 열리면 뜨개라운지에서 다시 한 번 ‘에디터로 불러오기’를 눌러 보세요.",
  },
  {
    id: "ans-7",
    postId: "qa-5",
